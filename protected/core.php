...
function run(){
	...
	try{
		...
		defined('__APPVIEW__') or empty($tems)? define('__APPVIEW__', __ROOT__ . '/protected/apps/' . APP_NAME . '/view') : define('__APPVIEW__', __ROOT__ . '/protected/apps/' . APP_NAME . '/view/'.$tems);
